...
@isset($celcius)
<p class="text-success">O valor de Fahrenheit convertido para Celcius: {{round($celcius, 2)}} F°</p> <!--Utilizei a função round para deixar a variavél somente com duas casas após a virgula-->
@endisset
@endsection
