...
@isset($f)
<p class="text-success">O valor de Celcius convertido para Fahrenheit: {{round($f, 2)}} F°</p> <!--Utilizei a função round para deixar a variavél somente com duas casas após a virgula-->
@endisset
@endsection
